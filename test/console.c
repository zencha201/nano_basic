...
int main(int argc, char *argv[])
{
    ...
    set_platform_print_ch(platform_print_ch);
    set_platform_fopen(platform_fopen);
    set_platform_fclose(platform_fclose);
    set_platform_fread(platform_fread);
    set_platform_fwrite(platform_fwrite);
